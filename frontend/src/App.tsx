          ...
          <a href="#home" onClick={() => setCurrentRoute('home')} className="logo-area">
            <div className="logo-icon">
              <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M50 20v50M35 35h30" stroke="#D4AF37" strokeWidth="4" />
                <path d="M50 70c-15 0-25-10-25-10s10 10 25 10 25-10 25-10-10 10-25 10z" fill="#D4AF37" />
                <path d="M25 60c0-20 15-30 25-40 10 10 25 20 25 40 0 5-5 10-10 10-10 0-15-20-15-20s-5 20-15 20c-5 0-10-5-10-10z" stroke="#D4AF37" strokeWidth="2" />
              </svg>
            </div>
