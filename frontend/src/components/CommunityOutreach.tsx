    ...
    <div>
      ...
      <motion.div className="page-header" variants={fadeUp} initial="hidden" animate="visible"
        ...
        <div className="container text-center">
          ...
          <h1 style={{ marginBottom: '0.75rem' }}>Community Outreach</h1>
          <p style={{ fontSize: '1.1rem', maxWidth: '580px', margin: '0 auto 2.5rem', color: 'rgba(255,255,255,0.85)' }}>
            We visit the sick, comfort the grieving, and stand beside those in crisis — because love is not just a feeling, it is an action.
          </p>
          ...
          <motion.div className="dark-card" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1.5rem', maxWidth: '600px', margin: '0 auto' }}>
                {[
                  { icon: <Phone size={20} />, label: '+256 700 000 000', href: 'tel:+256700000000' },
                  { icon: <Mail size={20} />, label: 'outreach@sic.ug', href: 'mailto:outreach@sic.ug' },
                  { icon: <MapPin size={20} />, label: 'SIC Chapel, Bugema University', href: '#' }
                ].map((c, i) => (
                  <a key={i} href={c.href}
                    style={{
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
